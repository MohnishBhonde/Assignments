...
public class AssignmentC2Q5 {
    public static void main(String[] args) {
        Map<Integer,String> map = new HashMap<>();

        employee e1 = new employee(1,"Mohnish Bhonde");
        employee e2 = new employee(1,"Vinit Yadav");
        employee e3 = new employee(3,"Yash Borkar");
        employee e4 = new employee(3,"Pratik Nandurkar");
        employee e5 = new employee(2,"Nakul K");
