...
class Parked_CarOwenerList extends AssignmentC2Q7{
    int id = 1;
    int levels = 3;
    int sections = 4;
    int slots = 20;
    Map<Integer,AssignmentC2Q7> car = new HashMap<>();
    Map<Integer,ParkingSlot> parkingSlotMap = new HashMap<>();

    public void add_new_car(AssignmentC2Q7 obj){
    ...
    public void remove_car(String name,int carNo){
        int key = 0;
        for (Map.Entry<Integer, AssignmentC2Q7> mp: car.entrySet()){
            AssignmentC2Q7 obj = mp.getValue();
...
public class AssignmentC2Q7 {
    ...
    public void menu(){
        ...
        do{
            ...
            choice = sc.nextInt();
            switch (choice){
                case 1: parked_carOwenerList.add_new_car(new AssignmentC2Q7());
                    break;
                case 2: String name;
                    int number;
    ...
    public static void main(String[] args) {
        AssignmentC2Q7 obj = new AssignmentC2Q7();
        obj.menu();
    }
}
